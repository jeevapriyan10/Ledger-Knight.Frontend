    ...
    <div className="sketch-modal" onClick={onClose}>
      <div className="sketch-modal-content" onClick={e => e.stopPropagation()}>
        ...
        <div style={{ display: 'grid', gap: 8, marginBottom: 16 }}>
          ...
          <div><strong>Comment:</strong> {tx.comment || 'No Comments Included'}</div>
          ...
          <div><strong>Etherscan:</strong> {tx.txHash ? <a className="sketch-link" href={`https://sepolia.etherscan.io/tx/${tx.txHash}`} target="_blank" rel="noreferrer">{tx.txHash}</a> : 'Transaction Declined By Auditor'}</div>
        </div>
    ...
    <div style={{ padding: 24, maxWidth: 1200, margin: '0 auto' }}>
      ...
      <div className="sketch-card">
        ...
        <div style={{ marginTop: 16 }}>
          {associates.length === 0 ? (
            <div className="sketch-text-small">No Associates Availabe! Use "Create Associate"</div>
          ) : (
